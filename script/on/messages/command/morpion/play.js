                                    ...
                                    if (mpParties[args[1]].positions[Number(args[2]) - 1] == 0) {
                                        ...
                                        */
                                        ...
                                        if (
                                            ...
                                            message.channel.send(`${message.author} a gagné !\n\`\`\`Positions (un 0 signifie que la case n'est pas occupé):\n\n${mpParties[args[1]].positions[6].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[7].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[8].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")}\n${mpParties[args[1]].positions[3].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[4].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[5].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")}\n${mpParties[args[1]].positions[0].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[1].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")} | ${mpParties[args[1]].positions[2].replace(/0/g," ").replace(/1/g,"O").replace(/2/g,"X")}\`\`\``);
